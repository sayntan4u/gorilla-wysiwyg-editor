class GorillaEditor {
  ...
  getPageElement(elem) {
    ...
    while (true) {
      ...
      if (currElem.classList.contains("go-page")) {
        pageElem = currElem;
        break;
      } else {
  ...
  renderPage() {
    ...
    const pages = this.editor.querySelectorAll(".go-page");
    pages[0].childNodes.forEach((element) => {
      totalHeight += element.offsetHeight;
    });
    // console.log(totalHeight);
    if (totalHeight >= 946 * this.pageCount) {
      if (this.pageCount == 1) {
        pages[pages.length - 1].style.height =
          parseInt(945 + 76).toString() + "px";
      } else {
        pages[pages.length - 1].style.height = parseInt(945).toString() + "px";
      }

      const newpage = document.createElement("div");
      // newpage.contentEditable = true;
      newpage.className = "go-page";
      // newpage.innerHTML = "<p><br></p>";
      this.editor.appendChild(newpage);
      this.pageCount += 1;
    }
    // console.log(this.pageCount);
  }
    ...
    buttons.forEach((button) => {
      if (button.type == "btn") {
        ...
        if (button.title == "alignment") {
          ...
          dropdown.className = "go-dropdown";
          ...
          dropdownContent.className = "go-dropdown-content";
          ...
          dropdown.onchange = () => {
            ...
            switch (dropdown.value) {
              ...
              case "Subtitle":
                ...
                document.execCommand("foreColor", false, "#b3b3b3");
                fontSize = "20px";
                break;
              case "Heading 1":
        ...
        if (button.title == "textColor") {
          ...
          colorPicker.className = "go-dropdown";
          ...
          colorPickerContent.className = "go-colorPicker-content";
  ...
  initEditor() {
    ...
    this.editor.addEventListener("input", () => {
      ...
      const page = this.editor.querySelector(".go-page");
      // pages.forEach((page) => {
    ...
    this.editor.addEventListener("keydown", (event) => {
      ...
      if (event.key == "Backspace") {
        if (this.pageCount > 1) {
          ...
          // console.log(totalHeight);
          if (totalHeight <= 946 * (this.pageCount - 1)) {
            pages[pages.length - 2].style.height = "270mm";
            pages[pages.length - 1].remove();
            this.pageCount -= 1;
            if(this.pageCount == 1){
              pages[0].style.height = "290mm";
            }
          }
        }
      }
      ...
      //   if (range && range.startContainer) {
      //     const parentElement = this.getPageElement(
      //       range.startContainer.parentElement
      //     );
      //     if (parentElement.classList.contains("go-page")) {
      ...
      if (headingDropdown) {
        ...
        switch (document.queryCommandValue("formatBlock")) {
          ...
          case "p":
            ...
            break;
          case "h1":
            headingDropdown.value = "Title";
            break;
          case "h2":
            headingDropdown.value = "Heading 1";
            break;
          case "h3":
            headingDropdown.value = "Subtitle";
            break;
          case "h4":
            headingDropdown.value = "Heading 3";
            break;
          case "h5":
            headingDropdown.value = "Heading 4";
            break;
        }
      }
