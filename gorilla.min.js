  ...
  initToolbar() {
    ...
    const buttons = [
      ...
      // },
      {
        type: "dropdown",
        title: "fontFamily",
        options: ["Roboto", "Arial", "Poppins", "Poiret"],
      },
      {
        type: "vr",
      },
    ...
    buttons.forEach((button) => {
      if (button.type == "btn") {
          ...
          dropdown.onchange = () => {
            ...
            if (range && range.startContainer) {
              ...
              if (!parentElement.classList.contains("go-editor")) {
                ["Roboto", "Arial", "Poppins", "Poiret"].forEach((item) => {
                  parentElement.classList.remove(item);
                });
                parentElement.classList.add(dropdown.value);
              }
            }
          };
        ...
        if (button.title == "textColor") {
          ...
          colorPickerButton.innerHTML = `<i class="go-toolbar-icon" data-lucide="baseline"></i>`;
          ...
          colors.forEach((color) => {
            ...
            colorBlock.onclick = () => {
              ...
              //   }
              // }
              document.execCommand("foreColor", false, colorBlock.style.backgroundColor)
  ...
  updateToolbarState() {
    ...
    if (range && range.startContainer) {
      ...
      if (fontFamilyDropdown) {
        // console.log(parentElement);
        if (!parentElement.classList.contains("go-editor")) {
          fontFamilyDropdown.value = parentElement.className || "Roboto";
        }
      }
